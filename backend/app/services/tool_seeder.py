...
BUILTIN_TOOLS = [
    ...
    },
    {
        ...
        "description": "Manage collaborators for any Feishu Drive file (documents, bitables, spreadsheets, folders). Add/remove/list collaborators with view/edit/full_access permissions.",
        "category": "feishu",
        "icon": "🤝",
        "is_default": False,
        "parameters_schema": {
            "type": "object",
            "properties": {
                "document_token": {"type": "string", "description": "Feishu file token"},
                "doc_type": {"type": "string", "description": "File type: docx, bitable, sheet, doc, folder. Default: docx"},
                "action": {"type": "string", "description": "'add', 'remove', or 'list'"},
                "member_names": {"type": "array", "items": {"type": "string"}, "description": "Colleague names to add/remove"},
                "permission": {"type": "string", "description": "Permission level: view, edit, full_access. Default: edit"},
            },
    ...
    },
    {
        ...
        "description": "Delete a file or folder from Feishu Drive. Supports all file types (documents, bitables, spreadsheets, folders). Files are moved to recycle bin.",
        "category": "feishu",
        "icon": "🗑️",
        "is_default": False,
        "parameters_schema": {
            ...
            "properties": {
                ...
                "file_type": {"type": "string", "description": "File type: docx, bitable, sheet, doc, folder, file"},
            },
